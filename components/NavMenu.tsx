...
export function NavMenu({}) {
  ...
  return (
    <div className="fixed z-50 w-full text-gray-900 bg-white bg-opacity-50 dark:bg-dark dark:text-gray-100 backdrop-filter backdrop-blur-lg dark:bg-opacity-50 transition-all duration-250 ease">
      <div className="flex items-center justify-between max-w-6xl px-4 py-3 mx-auto sm:px-6 md:space-x-10">
        <div className="flex justify-start lg:w-0 lg:flex-1">
          ...
          <Image
            ...
            height={48}
            width={48}
            src={siteMetadata.avatarNav}
            placeholder="blur"
            blurDataURL={siteMetadata.avatarNav}
            className="rounded-full cursor-pointer hover:contrast-125"
            onClick={() => router.push('/')}
          />
        </div>
        ...
        <nav className="hidden space-x-8 text-lg md:flex">
          <NavItem href="/" text={translate('home')} />
          <NavItem href="/about" text={translate('about')} />
          <NavItem href="/projects" text={translate('projects')} />
        </nav>
              ...
              <label
                className={`${
                  l === router.locale
                    ...
                    : 'font-normal text-gray-600 dark:text-gray-400'
                } 'hidden md:inline-block cursor-pointer px-2 mr-2 rounded-full hover:bg-gray-100 dark:hover:bg-midnight transition-all'`}
              >
                <input
                  type="checkbox"
                  className="hidden"
      ...
      {isOpen && (
        ...
        >
          ...
          <div className="fixed w-full max-w-xs p-6 text-base font-semibold text-gray-900 bg-white rounded-lg shadow-lg top-4 right-4 dark:bg-gray-800 dark:text-gray-400 dark:highlight-white/5">
            ...
            <div className="pt-6 mt-6 flex items-center justify-center border-t border-gray-200 dark:border-gray-200/10">
              <button
                aria-label="Toggle Dark Mode"
                type="button"
                className="flex items-center justify-center w-full py-3 mr-4 bg-gray-200 rounded-full dark:bg-midnight-hover general-ring-state"
                onClick={() =>
                  setTheme(resolvedTheme === 'dark' ? 'light' : 'dark')
                }
              >
